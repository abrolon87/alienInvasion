...
class AlienInvasion:
    ...
    def run_game(self):  # the game is controlled by run_game()
    ...
    def _update_aliens(self):
        """check if at edge, update position of aliens in fleet"""
    ...
    def _create_fleet(self):
        # make an alien
        alien = Alien(self)
        # self.aliens.add(alien) below we created a row of aliens
